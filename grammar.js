  ...
  points: [
    {
      ...
      sections:[
        ...
        {h:"A memory trick for the う-verb groups", t:"The sound changes look random but there's a rhythm worth internalizing. Many learners use a song set to 'Santa Claus is Coming to Town': う・つ・る → って, む・ぬ・ぶ → んで, く → いて, ぐ → いで, す → して. Sing it a few times and the groups stick. The reason these changes exist at all is euphony — Japanese smooths the boundary between the verb stem and て so it's easier to say. のむて would be awkward to pronounce; のんで flows. You don't need the linguistics, but knowing it's about ease-of-speech (not arbitrary rules) makes it less intimidating."},
